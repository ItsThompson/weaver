...
export async function mockFs() {
  ...
  return {
    ...
    appendFileSync: fs.appendFileSync as jest.MockedFunction<typeof fs.appendFileSync>,
    ...
    realpathSync: fs.realpathSync as unknown as jest.MockedFunction<(p: string) => string>,
  };
}
