...
export function promptResponse(prompt: string, response: string, ts?: string): ConversationTurn {
  return makeTurn(
    { Prompt: { prompt } },
...
export function promptToolUse(prompt: string, toolName: string, ts?: string): ConversationTurn {
  return makeTurn(
    { Prompt: { prompt } },
...
export function makeSavedConversation(history: ConversationTurn[], overrides?: Partial<SavedConversation>): SavedConversation {
  return {
